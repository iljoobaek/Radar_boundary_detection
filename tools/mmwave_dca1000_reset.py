...
#
# soft-reset of a TI mmWave EVM with TI's DCA1000EVM via FTDI
#
...
if __name__ == "__main__":
    ...
    if found:
        ...
        try:
            ...
            print('DCA:FTDI:C,GPIO -- FullReset()', file=sys.stderr)
        ...
        print('DCA1000EVM has not been found.', file=sys.stderr)
        sys.exit(1)
